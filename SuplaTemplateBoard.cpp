...
void chooseTemplateBoard(uint8_t board) {
  ...
  switch (board) {
    ...
    case BOARD_MINITIGER_3CH:
      ...
      addRelay(14);
      break;
     case BOARD_VINDRIKTNING:
      ConfigManager->set(KEY_HOST_NAME,"VINDRIKTNING" );
      addLedCFG(12, LOW);                             //D6
      addButtonCFG(16);                               //D0    
      // ConfigESP->setGpio(4, FUNCTION_SDA);            //D2
      // ConfigESP->setGpio(5, FUNCTION_SCL);            //D1
      ...
      // ConfigManager->setElement(KEY_ACTIVE_SENSOR, SENSOR_I2C_SHT3x,SHT3x_ADDRESS_0X44);
       ConfigManager->setElement(KEY_ACTIVE_SENSOR, SENSOR_I2C_BH1750,"0X23");
      
      ConfigESP->setGpio(2, FUNCTION_AIR_SENSOR_TX); //D4                 
      break; 
  }
}
